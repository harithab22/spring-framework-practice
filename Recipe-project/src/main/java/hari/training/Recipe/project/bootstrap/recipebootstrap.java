package hari.training.Recipe.project.bootstrap;

import hari.training.Recipe.project.Repositories.RecipeRepository;
import hari.training.Recipe.project.model.*;
...
public class recipebootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private final hari.training.Recipe.project.Repositories.categoryRepository categoryRepository;
    private final RecipeRepository recipeRepository;
    private final hari.training.Recipe.project.Repositories.unitofmeasureRepository unitofmeasureRepository;

    public recipebootstrap(hari.training.Recipe.project.Repositories.categoryRepository categoryRepository, RecipeRepository recipeRepository, hari.training.Recipe.project.Repositories.unitofmeasureRepository unitofmeasureRepository) {
